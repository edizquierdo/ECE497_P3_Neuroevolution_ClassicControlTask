...
class Braitenberg:
    ...
    def move(self):
        ...
        self.orientation += ((self.motors[1] - self.motors[0])/10) #+ np.random.normal(0,0.1) # Left - Right motor
        self.velocity = self.velocity #((self.rightmotor + self.leftmotor)/2)/10
